...
var UserModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            imports: [typeorm_1.TypeOrmModule.forFeature([user_entity_1.User]), cart_module_1.CartModule], // Make sure User entity is included here
            providers: [user_service_1.UserService],
            controllers: [user_controller_1.UserController],
            exports: [user_service_1.UserService], // Export UserService if used elsewhere
        })];
